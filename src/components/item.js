                ...
                <div className="item-selects">
                    <div className="item-select">
                        ...
                        <Select
                            id="height-select"
                            className="select"
                            defaultValue={flower.height || "70-80 см"} // Використовуємо значення з API або дефолтне
                        >
                    ...
                    <div className="item-select">
                        ...
                        <Select
                            id="size-select"
                            className="select"
                            defaultValue={flower.size || "Medium"} // Використовуємо значення з API або дефолтне
                        >
